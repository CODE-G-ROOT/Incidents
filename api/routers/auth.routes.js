...
auth.get("/login/redirect", passport.authenticate("discord", { failureRedirect: `http://${data.SERVER_FRONT.host}:${data.SERVER_FRONT.port}/404`, successRedirect: `http://${data.SERVER_FRONT.host}:${data.SERVER_FRONT.port}/admin`, }))
